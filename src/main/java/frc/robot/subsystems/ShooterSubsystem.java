...
import frc.robot.commands.scoring.shooter.StopShooterPeriodic;
import frc.robot.interfaces.TandemMotorInterface;
...
public class ShooterSubsystem extends Subsystem implements TandemMotorInterface {
	...
	public void shootForCurrentTarget() {
		...
		case SWITCH:
			...
			break;
		case SUPER_HIGH:
			runAtNativeUnitVelocity(Constants.ShooterRig.SUPER_HIGH_SPEED);
			break;
		default:
			break;
		}
...
//	}
	...
	public void incrementTarget() {
		...
		case SWITCH:
			...
			break;
		case SUPER_HIGH:
			currentTarget = ShotHeight.SUPER_HIGH;
			break;
		}
	}
